...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "kpi.high_value":         "high value",
        "kpi.high_value_sub":     "durable + reused",
        "kpi.transient":          "transient",
        "kpi.transient_sub":      "output without reuse",
        "kpi.low_value":          "low value",
        "kpi.low_value_sub":      "poor value per token",
        "kpi.wasted":             "wasted",
        "kpi.wasted_sub":         "zero durable return",
        ...
        "modal.section.prompts":  "Prompts ({n}) — ordered by cost",
        ...
        "team.active_employees":       "active employees",
        "team.total_spend":            "team token spend",
        "team.total_spend_sub":        "effective cost across all members",
        "team.avg_efficiency":         "avg efficiency",
        "team.avg_efficiency_sub":     "LLM-judged, 0 to 1",
        "team.high_value_sessions":    "high-value sessions",
        "team.high_value_sessions_sub":"LLM verdict ≥ 0.85",
        "team.waste_alerts":           "waste alerts",
        "team.waste_alerts_sub":       "LOW_VALUE or WASTED classifications",
        "team.top_waste_patterns":     "most common waste patterns (from local LLM)",
        "team.no_patterns_yet":        "no waste patterns yet — run `token-roi judge` to populate.",
        "team.roi_distribution":       "team ROI distribution",
        "team.leaderboard":            "waste leaderboard — the sessions burning the most tokens for the least value",
    ...
    "zh": {
        ...
        "kpi.high_value":         "高价值",
        "kpi.high_value_sub":     "持久且被复用",
        "kpi.transient":          "过渡价值",
        "kpi.transient_sub":      "有产出但未复用",
        "kpi.low_value":          "低价值",
        "kpi.low_value_sub":      "每 Token 价值偏低",
        "kpi.wasted":             "浪费",
        "kpi.wasted_sub":         "无持久回报",

        # ---- card headers ----
        "card.roi_distribution":      "ROI 分布",
        "card.cost_breakdown":        "各会话 Token 用量构成",
        "card.top_spenders":          "Token 消耗 Top 榜（按 ROI 分类着色）",
        ...
        "llm.not_yet_run":      "未运行",
        "llm.judgments_meta":   "共 {n} 条评审 · 模型{s}：{models} · 平均实质性 {meaningful} · 平均持久性 {durability}",
        "llm.meaningful":       "实质性",
        "llm.durability":       "持久性",
        "llm.efficiency":       "效率",
        "llm.code":             "代码质量",
        ...
        "modal.section.prompts":  "提示列表（共 {n} 条，按成本排序）",
        "modal.section.files":    "生成文件 Top（共 {n} 个）",
        ...
        # ---- team view ----
        "team.heading":                "团队总览",
        "team.active_employees":       "活跃员工",
        "team.total_spend":            "团队 Token 消耗",
        "team.total_spend_sub":        "所有成员的有效成本合计",
        "team.avg_efficiency":         "平均效率",
        "team.avg_efficiency_sub":     "LLM 评审，0 至 1",
        "team.high_value_sessions":    "高价值会话",
        "team.high_value_sessions_sub":"LLM 综合评分 ≥ 0.85",
        "team.waste_alerts":           "浪费预警",
        "team.waste_alerts_sub":       "低价值或浪费级别的会话",
        "team.top_waste_patterns":     "最常见的浪费模式（由本地 LLM 识别）",
        "team.no_patterns_yet":        "暂无浪费模式 — 运行 `token-roi judge` 后生成。",
        "team.roi_distribution":       "团队 ROI 分布",
        "team.leaderboard":            "浪费排行榜 — 按「花费最多、产出最少」排序的会话",
